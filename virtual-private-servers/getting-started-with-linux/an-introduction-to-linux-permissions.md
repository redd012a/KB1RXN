...
#### Reading Symbolic Permissions {#reading-symbolic-permissions}
...
### Understanding Read, Write, Execute {#understanding-read-write-execute}
...
### Modifying Ownership and Permissions {#modifying-ownership-and-permissions}
