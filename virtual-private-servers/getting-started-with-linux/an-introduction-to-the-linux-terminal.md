...
#### Without Arguments or Options {#without-arguments-or-options}
...
#### With Options and Arguments {#with-options-and-arguments}
...
#### View the Value of a Variable {#view-the-value-of-a-variable}
...
Now that you have learned about the basics of the Linux terminal \(and a few commands\), you should have a good foundation for expanding your knowledge of Linux commands. Read the [next tutorial in this series](https://www.digitalocean.com/community/tutorials/basic-linux-navigation-and-file-management) to learn how to navigate, view, and edit files and their permissions
